...
kpis:
  ...
  - label: 'Self-refuted hypothesis'
    ...
    impact: 'The negative result is published as a result'
    impactEs: 'El resultado negativo se publica como resultado'
