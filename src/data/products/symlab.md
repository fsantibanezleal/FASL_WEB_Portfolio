...
kpis:
  ...
  - label: 'Search families'
    ...
    impact: 'Two families with nothing in common, scored by the same metrics'
    impactEs: 'Dos familias sin nada en común, puntuadas con las mismas métricas'
