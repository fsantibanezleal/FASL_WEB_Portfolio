...
icon: tabler:atom
tags: [quantum-computing, qiskit, pennylane, cirq, stim, education, benchmarks]
proprietary: false
featured: false
...
kpis:
  - label: 'Practical quantum speedups demonstrated'
    ...
    impact: 'Teaches the field verdict, with costs on screen'
    impactEs: 'Enseña el veredicto del campo, con los costos en pantalla'
