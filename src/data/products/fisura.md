...
metrics:
  ...
  - label: 'Scope'
    labelEs: 'Alcance'
    value: 'A method-comparison research lab, NOT a certified inspection tool; full data kept outside the repo; under active build-out'
    valueEs: 'Un laboratorio de comparación de métodos, NO una herramienta de inspección certificada; data completa fuera del repo; en construcción activa'
