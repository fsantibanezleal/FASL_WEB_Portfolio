...
kpis:
  ...
  - label: 'Exact solve, in the browser'
    ...
    result: '14,153 blocks / 219,778 precedences solved exactly in ~207 ms median (Node median-of-3 bake of the same TypeScript engine the browser runs; Dinic min-cut over Picard reduction)'
    resultEs: '14.153 bloques / 219.778 precedencias resueltos de forma exacta en ~207 ms de mediana (bake en Node, mediana de 3, del mismo motor TypeScript que corre el navegador; corte minimo Dinic sobre reduccion de Picard)'
...
metrics:
  ...
  - label: 'MineLib validation'
    ...
    value: 'newman1 (1,060 blocks, 1.9 ms), zuck_small (9,400 blocks, 111 ms), kd (14,153 blocks, 207 ms), Node medians of 3, all match: true, rel. error 1.30e-10 to 9.96e-10; 3 instances excluded with committed reasons'
    valueEs: 'newman1 (1.060 bloques, 1,9 ms), zuck_small (9.400 bloques, 111 ms), kd (14.153 bloques, 207 ms), medianas de 3 en Node, todos match: true, error rel. 1,30e-10 a 9,96e-10; 3 instancias excluidas con razones commiteadas'
...
- **newman1**: 1,060 blocks, solved in 1.9 ms median, relative error 9.96e-10
- **zuck_small**: 9,400 blocks, 111 ms, 1.86e-10
- **kd**: 14,153 blocks / 219,778 precedences, 207 ms, 1.30e-10

Those are Node medians of three, measured on the same TypeScript engine the browser runs; an independent pseudoflow rung takes 8.3 ms, 11.6 s and 12.2 s on the same three instances.
